	...
	<div class="page-header-top">
		<div class="container">
			...
			<div class="page-logo" style="width:400px">
				<a href="index.html">
                	<div style="float:left; margin-top:21px"><span style="color:#333333;font-size:26px;">CARI</span> <span style="font-size:26px; color:#ff3f3f;">CAMERA</div>
                </a>
			</div>
			<!-- END LOGO -->
		...
		<div class="container">
			...
			<div class="hor-menu ">
				<ul class="nav navbar-nav">
					<li>
						<a href="fr"><i class="fa fa-comments"></i> Conversational Recommender System Berdasarkan Kebutuhan Fungsional</a>
					</li>                    
				</ul>
			</div>
			<!-- END MEGA MENU -->
